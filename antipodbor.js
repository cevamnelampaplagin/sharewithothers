(function() {
    ...
    // Локализация
    Lampa.Lang.add({
        sursSelect_vote_count_desc: { en: "Most Votes", uk: "Багато голосів" },
        sursSelect_vote_average_desc: { en: "High Rating", uk: "Високий рейтинг" },
        sursSelect_first_air_date_desc: { en: "New Releases", uk: "Новинки" },
        sursSelect_popularity_desc: { en: "Popular", uk: "Популярні" },
        sursSelect_revenue_desc: { en: "Box Office", uk: "Касові збори" },
        sursSelect_menu_title: { en: "Sections", uk: "Розділи" },
        sursSelect_movies: { en: "Movies", uk: "Фільми" },
        sursSelect_tvshows: { en: "TV Shows", uk: "Серіали" },
        sursSelect_dorama_tvshows: { en: "Korean dramas", uk: "Корейські драми" },  
        sursSelect_turkish_tvshows: { en: "Turkish series", uk: "Турецькі серіали" },
        sursSelect_streaming: { en: "Streaming", uk: "Стрімінг" },
        sursSelect_kids: { en: "For Kids", uk: "Для дітей" },
        sursSelect_all_movies: { en: "All Movies", uk: "Усі фільми" },
        sursSelect_animated_movies: { en: "Animated Movies", uk: "Мультфільми" },
        sursSelect_all_tvshows: { en: "All TV Shows", uk: "Усі серіали" },
        sursSelect_animated_tvshows: { en: "Animated TV Shows", uk: "Мультсеріали" },
        sursSelect_kids_movies: { en: "Cartoons", uk: "Мультфільми" },
        sursSelect_kids_tvshows: { en: "Cartoon Series", uk: "Мультсеріали" },
        sursSelect_kids_family: { en: "Family", uk: "Сімейні" },
        sursSelect_global_streaming: { en: "Global Streaming", uk: "Глобальний стрімінг" },
        sursSelect_service_selection: { en: "Service Selection", uk: "Вибір сервісу" },
        sursSelect_sorting: { en: "Sorting", uk: "Сортування" },
        sursSelect_menu_item: { en: "Collections", uk: "Колекції" },
        sursSelect_lnum_collections: { en: 'LNUM - Collections', uk: 'LNUM - Колекції' },
        surs_select_plugins_section_title: { en: 'Third-party plugins', uk: 'Сторонні плагіни' }
    });
    ...
    function showSursSelectMenu() {
        ...
        Lampa.Select.show({
            ...
            onSelect: function (item) {
                ...
                else if (item.action === 'streaming') showServiceList(allStreamingServices, true);
        ...
        Lampa.Select.show({
            ...
            onBack: function () {
                if (service.isStreaming) {
                    showServiceList(allStreamingServices, true);
